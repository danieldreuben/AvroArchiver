...
public class ArchiveJobParams2 {
    ...
    public static ArchiveJobParams2 getInstance(String job) {
        try {       
            if (job.contains(".")) {
                File file = new File(job);
                ArchiveJobParams2 params = new ArchiveJobParams2();
            ...
            ArchiveJobParams2 config = mapper.readValue(new File(fullPath), ArchiveJobParams2.class);
